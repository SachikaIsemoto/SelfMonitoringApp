...
{
    public partial class ThoughtEditForm : ThoughtDetailForm
    {
        public ThoughtEditForm()
        {
            InitializeComponent();
        }

        private void ThoughtEditForm_Load(object sender, EventArgs e)
        {
            /* データ設定 */
        ...
        private void recordButton_Click(object sender, EventArgs e)
        {
            ...
            DataControl.EditThoughtRecord(record);
